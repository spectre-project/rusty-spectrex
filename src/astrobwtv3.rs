...
pub fn astrobwtv3_hash(input: &[u8]) -> [u8; 32] {
    ...
    loop {
        ...
        match op {
            0 => {
                for i in pos1..pos2 {
                    data[i as usize] = data[i as usize] ^ data[i as usize].count_ones() as u8;       // ones count bits
                    data[i as usize] = data[i as usize].rotate_left(5);                              // rotate bits by 5
                    data[i as usize] = data[i as usize].wrapping_mul(data[i as usize]);              // *
                    data[i as usize] = data[i as usize].rotate_left(data[i as usize] as u32);        // rotate bits by random
            ...
            1 => {
                for i in pos1..pos2 {
                    data[i as usize] = data[i as usize].wrapping_shl((data[i as usize] & 3) as u32); // shift left
                    data[i as usize] = data[i as usize].rotate_left(1);                              // rotate bits by 1
                    data[i as usize] = data[i as usize] & data[pos2 as usize];                       // AND
                    data[i as usize] = data[i as usize].wrapping_add(data[i as usize]);              // +
                }
            }
            2 => {
                for i in pos1..pos2 {
                    data[i as usize] = data[i as usize] ^ data[i as usize].count_ones() as u8;       // ones count bits
                    data[i as usize] = data[i as usize].reverse_bits();                              // reverse bits
                    data[i as usize] = data[i as usize].wrapping_shl((data[i as usize] & 3) as u32); // shift left
                    data[i as usize] = data[i as usize] ^ data[i as usize].count_ones() as u8;       // ones count bits
                }
            }
            3 => {
                for i in pos1..pos2 {
                    data[i as usize] = data[i as usize].rotate_left(data[i as usize] as u32);        // rotate bits by random
                    data[i as usize] = data[i as usize].rotate_left(3);                              // rotate bits by 3
                    data[i as usize] = data[i as usize] ^ data[pos2 as usize];                       // XOR
                    data[i as usize] = data[i as usize].rotate_left(1);                              // rotate bits by 1
                }
            }
            4 => {
                for i in pos1..pos2 {
                    data[i as usize] = !data[i as usize];                                            // binary NOT operator
                    data[i as usize] = data[i as usize].wrapping_shr((data[i as usize] & 3) as u32); // shift right
                    data[i as usize] = data[i as usize].rotate_left(data[i as usize] as u32);        // rotate bits by random
                    data[i as usize] = data[i as usize].wrapping_sub(data[i as usize] ^ 97);         // XOR and -
                }
            }
            5 => {
                for i in pos1..pos2 {
            ...
            9 => {
                for i in pos1..pos2 {
                    data[i as usize] = data[i as usize] ^ data[pos2 as usize];                       // XOR
                    data[i as usize] = data[i as usize] ^ data[i as usize].rotate_left(4);           // rotate bits by 4
                    data[i as usize] = data[i as usize].wrapping_shr((data[i as usize] & 3) as u32); // shift right
                    data[i as usize] = data[i as usize] ^ data[i as usize].rotate_left(2);           // rotate bits by 2
                }
            }
            10 => {
                for i in pos1..pos2 {
